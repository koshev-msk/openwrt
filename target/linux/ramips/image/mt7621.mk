...
define Device/huasifei_ws1208v2-16m
  ...
  SUPPORTED_DEVICES += huasifei,huasifei-ws1208v2-16m
endef
...
define Device/huasifei_ws1208v2-32m
  ...
  DEVICE_VARIANT := 32M
  DEVICE_PACKAGES := kmod-mt7603 kmod-mt76x2 kmod-usb3 kmod-usb-ledtrig-usbport
  SUPPORTED_DEVICES += huasifei,huasifei-ws1208v2-32m
endef
...
define Device/weblink_hdrm200
  $(Device/dsa-migration)
  $(Device/uimage-lzma-loader)
  IMAGE_SIZE := 16064k
  DEVICE_VENDOR := WebLink
  DEVICE_MODEL := HDRM200
  DEVICE_PACKAGES := kmod-mt7603 kmod-mt76x2 kmod-usb3 kmod-usb-ledtrig-usbport
endef
TARGET_DEVICES += weblink_hdrm200
