...
define Device/cudy_wbr3000uax-v1-256
  DEVICE_VENDOR := Cudy
  DEVICE_MODEL := WBR3000UAX
  DEVICE_VARIANT := v1 256mb
  DEVICE_DTS := mt7981b-cudy-wbr3000uax-v1-256
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := kmod-usb3 kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  ...
  ARTIFACTS := preloader.bin bl31-uboot.fip
  ARTIFACT/preloader.bin := mt7981-bl2 cudy-ddr3
  ARTIFACT/bl31-uboot.fip := mt7981-bl31-uboot cudy_wbr3000uax-v1-256
endef
TARGET_DEVICES += cudy_wbr3000uax-v1-256
...
define Device/snr_cpe-ax2
  DEVICE_VENDOR := SNR
  DEVICE_MODEL :=  CPE-AX2
  ...
  IMAGE/factory.bin := append-ubi | check-size $$(IMAGE_SIZE)
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
  SUPPORTED_DEVICES += snr-cpe-ax2 snr-cpe-ax2-jcg
endef
TARGET_DEVICES += snr_cpe-ax2
...
define Device/zbtlink_zbt-z8105ax-nand
  DEVICE_VENDOR := Zbtlink
  DEVICE_MODEL := ZBT-Z8105AX
  DEVICE_VARIANT := (ALL nAND)
  DEVICE_DTS := mt7981b-zbtlink-zbt-z8105ax-nand
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware kmod-usb3
  KERNEL_IN_UBI := 1
  UBINIZE_OPTS := -E 5
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += zbtlink_zbt-z8105ax-nand
